...
**Color Notes:** Dark cinema primary (#050506 / #0a0a0f) + indigo accent `#5E6AD2` / sky cyan `#7dd3fc`. Do not replace Portfolio layout skeleton; only retune tokens + card chrome.
