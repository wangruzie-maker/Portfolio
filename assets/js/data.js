window.siteConfig = {
  ...
  workLead: "爆款内容、Agent 工具与四段实习入口——每张卡片对应一段可核验的结果。",
  aboutTitle: "把经历说清楚",
...
window.portfolioWorks = [
  ...
  },
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=80",
    externalUrl: "",
    timelineSubTag: "百度 · 子页面待接入",
    tags: ["Baidu", "Marketing", "SOP"],
    summaryCn: "ACG 智能云市场部实习专页入口（子页面已设计，稍后接入）。",
    accent: "lime",
    featured: true
  },
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=900&q=80",
    externalUrl: "",
    timelineSubTag: "趣丸 · 子页面待接入",
    tags: ["Quwan", "Product", "Agent"],
    summaryCn: "产品实习与 Wefly Agent 专页入口（子页面已设计，稍后接入）。",
    accent: "violet",
    featured: true
  },
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=900&q=80",
    externalUrl: "",
    timelineSubTag: "讯飞 · 子页面待接入",
    tags: ["iFLYTEK", "Ads", "Ops"],
    summaryCn: "产品运营与海外投流专页入口（子页面已设计，稍后接入）。",
    accent: "cyan",
    featured: true
  },
  {
    ...
    externalUrl: "",
    timelineSubTag: "紫讯 · 子页面待接入",
    tags: ["SellerPic", "YouTube", "Growth"],
    summaryCn: "AI 内容运营与海外账号增长专页入口（子页面已设计，稍后接入）。",
    accent: "cyan",
    featured: true
  }
];
