...
window.portfolioWorks = [
  ...
  },
  {
    ...
    summaryCn: "自建物料创作到数据闭环平台，支撑 80 个矩阵号高质量低成本自动化生产，已推广至智能云全体市场部；并独立搭建信息提取与爆款复刻工具。",
    accent: "lime",
    featured: true
  },
  {
    ...
    tags: ["Agent", "Ads", "AIGC"],
    summaryCn: "协助搭建广告投放与信息流素材 Agent；用 Figma 梳理需求原型，将业务 SOP 封装为 Skill，并打通与内部 AIGC「元境」的中台闭环。",
    accent: "violet",
    featured: true
  },
  {
